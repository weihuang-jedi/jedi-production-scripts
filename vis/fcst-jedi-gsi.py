...
#-----------------------------------------------------------------------------------------
  ...
  gsifile = '%s/%s/%s_%s_fhr06_ensmean' %(gsidir, datestr, type, datestr)
  jedifile = '%s/%s/%s_%s_fhr06_ensmean' %(jedidir, datestr, type, datestr)
  ...
  for n in range(len(varlist)):
   ...
   #print('gsivar.shape = ', gsivar.shape)
    ...
    for lev in range(5, nlev, 10):
      ...
      imagename = '%s_%s_lev_%3.3d.png' %(type, varlist[n], lev)
